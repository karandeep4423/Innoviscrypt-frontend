    ...
    <div className="mt-10 bg-slate-100">
      ...
      <div className="-mt-4 max-w-screen-xl m-auto flex flex-wrap space-x-5 px-5 justify-evenly">
        <div className="flex flex-col  font-medium space-y-4 pt-10">
          ...
          <Link href="/">Home</Link>
          <Link href="/choose-your-lesson">About</Link>
          <Link href="/gurbani-in-english">Pricing</Link>
          <Link href="/about-us">App</Link>
        </div>
        <div className="flex flex-col font-medium space-y-4 pt-10">
          <h2 className="text-xl font-medium ">ACCOUNT</h2>
          <Link href="/choose-your-lesson#book-lesson">Sign In</Link>
          <Link href="/choose-your-lesson#group-class">Sign Up</Link>
          <Link href="/choose-your-lesson#buy-hours">Reset Password</Link>
          <Link href="/choose-your-lesson#subscription">User Account</Link>
        </div>
        <div className="flex flex-col font-medium space-y-4 pt-10">
          <h2 className="text-xl  font-medium">TEMPLATE</h2>
          <p>Style Guide</p>
          <a href="mailto:bachiwind3@gmail.com">License</a>
          <a href="tel:+918727989814">Changelog</a>
        </div>
        <div className="flex flex-col font-medium space-y-4 pt-10">
